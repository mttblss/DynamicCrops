...
An extension for the Umbraco CMS to handle background images in variable aspect ratio containers ensuring that the focal point of the image is always respected.